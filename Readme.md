# 🎓 Sinara - Repositório Acadêmico Institucional
...
O projeto **Sinara** nasceu da necessidade de resolver a fragmentação das produções acadêmicas dentro da instituição. Muitas vezes, projetos incríveis desenvolvidos por alunos e professores ficavam perdidos após a conclusão dos cursos. 

O Sinara atua como uma biblioteca digital, permitindo a publicação, busca estruturada e visualização de trabalhos, TCCs e pesquisas, fomentando a disseminação do conhecimento.
...
* **Interface Responsiva:** Design limpo e adaptável desenvolvido com HTML e CSS.

---

## 🛠 Tecnologias Utilizadas

Este projeto foi construído utilizando uma arquitetura Full Stack focada em tecnologias web fundamentais:

* **Backend:** PHP
* **Banco de Dados:** MySQL (Consultas SQL relacionais)
...
### 1. Pré-requisitos
* Um servidor local configurado (recomenda-se **XAMPP** ou **WampServer**).
* Git instalado.
